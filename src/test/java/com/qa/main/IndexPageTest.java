...
public class IndexPageTest {
	...
	private String url = "http://127.0.0.1:5501/index.html";

	@BeforeClass
	public static void init() {
		extent = new ExtentReports("src/test/resources/reports/IndexPageReport.html", true);

	}

	@Before
	public void setup() {
		test = extent.startTest("To-Do App Index Page: Test Number " + ++count);
	...
	public void testEmployeeButton() {
		driver.get(url);
		WebElement home = driver.findElement(By.cssSelector("body > div > a:nth-child(5)"));
		home.click();
	...
	public void testTaskButton() {
		driver.get(url);
		WebElement home = driver.findElement(By.cssSelector("body > div > a:nth-child(6)"));
		home.click();
