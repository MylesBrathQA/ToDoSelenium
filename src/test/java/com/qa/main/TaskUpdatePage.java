...
public class TaskUpdatePage {
	private static ExtentReports extent;
	private static ExtentTest test;
	private static int count = 0;
	private WebDriver driver;
	private String url = "http://127.0.0.1:5501/html/task_update.html";

	@BeforeClass
	public static void init() {
		extent = new ExtentReports("src/test/resources/reports/TaskUpdatePageReport.html", true);

	}

	@Before
	public void setup() {
		test = extent.startTest("To-Do App Task Update Page: Test Number " + ++count);
