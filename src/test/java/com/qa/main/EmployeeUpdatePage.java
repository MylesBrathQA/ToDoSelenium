...
public class EmployeeUpdatePage {
	...
	private String url = "http://127.0.0.1:5501/html/emp_update.html";

	@BeforeClass
	public static void init() {
		extent = new ExtentReports("src/test/resources/reports/EmployeeUpdatePageReport.html", true);

	}

	@Before
	public void setup() {
		test = extent.startTest("To-Do App Employee Update Page: Test Number " + ++count);
