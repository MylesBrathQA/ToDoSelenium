...
public class TaskPageTest {
	...
	private String url = "http://127.0.0.1:5501/html/task.html";

	@BeforeClass
	public static void init() {
		extent = new ExtentReports("src/test/resources/reports/TaskPageReport.html", true);

	}

	@Before
	public void setup() {
		test = extent.startTest("To-Do App Task Page: Test Number " + ++count);
